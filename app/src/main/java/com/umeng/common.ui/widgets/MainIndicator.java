...
//    }
     ...
     * 设置高亮、正常颜色
     *
     * @param normalC highlightC
     */
    public void setTvBgColor(String normalC, String highlightC, String[] datas, int lineHsize) {
        this.COLOR_TEXT_NORMAL = normalC.equals("0") ? ColorQueque.getColor("umeng_comm_indicator_default") : Color.parseColor(normalC);
        this.COLOR_TEXT_HIGHLIGHTCOLOR = highlightC.equals("0") ? ColorQueque.getColor("umeng_comm_indicator_highlight") : Color.parseColor(highlightC);
        this.lineHsize = lineHsize == 0 ? 2 : lineHsize;

        setTabItemTitles(datas);
...
//            }else{
            drawableLine.setBounds(0, 0, drawableLine.getMinimumWidth(), DeviceUtils.dp2px(getContext(), lineHsize));
