...
public class TopicIndicator extends MainIndicator{
    ...
    public TopicIndicator(Context context, AttributeSet attrs) {
        ...
        COLOR_TEXT_NORMAL = ColorQueque.getColor("umeng_comm_search_default_text");
...
//                mDividerLinePaint);
    ...
    protected void highLightTextView(int position) {
        ...
        if (view instanceof TextView) {
            ((TextView) view).setTextColor(ColorQueque.getColor("umeng_comm_category_title_color"));
    ...
    protected void resetTextViewColor() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (view instanceof TextView) {
                ((TextView) view).setTextColor(ColorQueque.getColor("umeng_comm_small_title_color"));
    ...
    private TextView generateView(int index,String text) {
        ...
        tv.setTextColor(ColorQueque.getColor("umeng_comm_small_title_color"));
        tv.setText(text);
