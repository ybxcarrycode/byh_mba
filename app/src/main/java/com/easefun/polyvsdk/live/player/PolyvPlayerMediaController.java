...
public class PolyvPlayerMediaController extends PolyvLiveMediaController implements View.OnClickListener {
    ...
    public void changeToPortrait() {
        ...
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, (int) mContext.getResources().getDimension(R.dimen.dimen_204dp));
        parentView.setLayoutParams(lp);
    }
