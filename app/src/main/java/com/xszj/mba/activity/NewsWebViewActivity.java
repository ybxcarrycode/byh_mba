...
public class NewsWebViewActivity extends BaseActivity {
    ...
    protected int getContentViewResId() {
        mContext = NewsWebViewActivity.this;
...
//        webView.loadUrl("http://services.yunshuxie.com/wap/mkhxsqbj/sqcourse.html");  YSXConsts.ServiceConsts.SERVICE_SERVICES_ADDR + "wap/cjbj/AddClass.jsp"
        ...
        webView.loadUrl(url);
        webView.addJavascriptInterface(new JavascriptInterface(NewsWebViewActivity.this), "imagelistner");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                webView.addJavascriptInterface(NewsWebViewActivity.this, "androidRollBack()");
                return true;
            }
        });
