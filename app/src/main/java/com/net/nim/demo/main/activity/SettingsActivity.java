package com.net.nim.demo.main.activity;
...
import com.net.nim.demo.avchat.activity.AVChatSettingsActivity;
import com.net.nim.demo.contact.activity.UserProfileSettingActivity;
import com.net.nim.demo.main.adapter.SettingsAdapter;
import com.net.nim.demo.main.model.SettingType;
import com.net.nim.demo.NimApplication;
import com.net.nim.demo.config.preference.Preferences;
import com.net.nim.demo.config.preference.UserPreferences;
import com.net.nim.demo.main.model.SettingTemplate;
...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private void logout() {
        removeLoginState();
        startActivity(new Intent(SettingsActivity.this, com.xszj.mba.activity.MainActivity.class));
    ...
    private void removeLoginState() {
        ...
        if (CommonUtils.isLogin(SettingsActivity.this)) {
            CommunitySDK sdk = CommunityFactory.getCommSDK(this);
            sdk.logout(SettingsActivity.this, new LoginListener() {
                @Override
                public void onStart() {
                }
