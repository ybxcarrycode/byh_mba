package com.net.nim.demo.session;
...
import com.net.nim.demo.session.action.FileAction;
import com.net.nim.demo.session.action.SnapChatAction;
import com.net.nim.demo.session.search.SearchMessageActivity;
import com.net.nim.demo.session.viewholder.MsgViewHolderAVChat;
import com.net.nim.demo.DemoCache;
import com.net.nim.demo.contact.activity.UserProfileActivity;
import com.net.nim.demo.session.action.AVChatAction;
import com.net.nim.demo.session.action.GuessAction;
import com.net.nim.demo.session.action.TipAction;
import com.net.nim.demo.session.activity.MessageHistoryActivity;
import com.net.nim.demo.session.activity.MessageInfoActivity;
import com.net.nim.demo.session.extension.CustomAttachParser;
import com.net.nim.demo.session.extension.CustomAttachment;
import com.net.nim.demo.session.extension.GuessAttachment;
import com.net.nim.demo.session.extension.RTSAttachment;
import com.net.nim.demo.session.extension.SnapChatAttachment;
import com.net.nim.demo.session.extension.StickerAttachment;
import com.net.nim.demo.session.viewholder.MsgViewHolderDefCustom;
import com.net.nim.demo.session.viewholder.MsgViewHolderFile;
import com.net.nim.demo.session.viewholder.MsgViewHolderGuess;
import com.net.nim.demo.session.viewholder.MsgViewHolderRTS;
import com.net.nim.demo.session.viewholder.MsgViewHolderSnapChat;
import com.net.nim.demo.session.viewholder.MsgViewHolderSticker;
import com.net.nim.demo.session.viewholder.MsgViewHolderTip;
